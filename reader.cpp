...
\ \ \____  \ \  __ \  \ \  __\ \ \  __\ \ \  __\   \ \  __<
 \ \_____\  \ \_\ \_\  \ \_\    \ \_\    \ \_____\  \ \_\ \_\
  \/_____/   \/_/\/_/   \/_/     \/_/     \/_____/   \/_/ /_/
        ...
        if (argc == 1) {
            std::cerr << "There were no parameters given, use --help to show help menu." << std::endl;
            return -1;
        }
        ...
        if (argc == 2) {
            if (input_string.compare("--help") == 0) {
                ...
                std::cerr << "Invalid parameters, use --help to see the help" << std::endl;
                return -1;
            }
        }
        if (argc < 3) {
            std::cerr << "You have to define -ciff or -caff and a path to the file" << std::endl;
            return -1;
        }
        if (argc > 3) {
            std::cerr << "You have given too much parameters" << std::endl;
            return -1;
        }
